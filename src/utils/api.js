...
const API_BASE_URL = import.meta.env.VITE_API_URL || "https://snwv9cpm-8000.asse.devtunnels.ms";
...
export const pricingAPI = {
  ...
  getPlan: async (id) => {
    try {
      ...
      throw new Error(error.response?.data?.message || 'Failed to fetch pricing plan');
    }
  },
};
