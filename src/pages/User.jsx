      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-50">
        <div className="text-center">
          <div className="relative">
            ...
            <div
              className="absolute inset-0 w-16 h-16 border-4 border-blue-200 border-b-blue-600 rounded-full animate-spin mx-auto"
              style={{
    ...
    },
    {
      ...
      value: (events
        ? events.filter(
            (event) =>
              event.is_published &&
              (event.admin?.id === userData.id ||
                event.created_by === userData.id ||
              ...
              <div className="space-y-6">
                {events && events.length > 0 ? (
                  [...events]
                    ...
                    .sort(
                      (a, b) =>
                        new Date(b.updated_at || b.created_at || b.date) -
                        new Date(a.updated_at || a.created_at || a.date)
                    )
                    .slice(0, 5)
                    .map((event) => (
                      <div
                        key={event.id}
                        className="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-100"
                      >
