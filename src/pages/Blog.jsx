  ...
  const blogPosts = [
    {
      ...
      excerpt: "Learn the fundamental SEO strategies that can help your website rank higher in search engine results.",
    ...
    },
    {
      ...
      excerpt: "Color psychology and practical tips for selecting colors that represent your brand effectively.",
      image: "/placeholder.svg?height=300&width=400",
    ...
    },
    {
      ...
      excerpt: "Essential security measures every website owner should implement to protect their users.",
      image: "/placeholder.svg?height=300&width=400",
    ...
    },
    {
      ...
      excerpt: "How understanding user psychology can improve your website's conversion rates.",
      image: "/placeholder.svg?height=300&width=400",
      author: "James Wilson",
      date: "March 3, 2024",
      category: "UX Design",
    ...
    },
    {
      ...
      excerpt: "Proven strategies to optimize your online store and increase sales.",
      image: "/placeholder.svg?height=300&width=400",
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Stay updated with the latest insights, tips, and trends in web design, development, and digital marketing.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <h2 className="text-2xl font-heading font-bold text-gray-900 mb-8">Featured Article</h2>
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="md:flex">
                ...
                <div className="md:w-1/2 p-8">
                  ...
                  <h3 className="text-2xl font-heading font-bold text-gray-900 mb-4">{featuredPost.title}</h3>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-heading font-bold text-gray-900 mb-8">Latest Articles</h2>
